...
namespace MethodExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var subtraction = Subtract(8, 5);
            Console.WriteLine(subtraction);

            var multiplication = Multiply(5, 7);
            Console.WriteLine(multiplication);

            var division = Divide(8, 2);
            Console.WriteLine(division);
            
            int sum = Params.AnyLengthSum(1, 2, 4, 67, 42);
            Console.WriteLine(sum);

            int difference = Params.AnyLengthDif(1, 2, 4, 67, 42);
            Console.WriteLine(difference);

            int product = Params.AnyLengthProd(7, 3, 8, 2);
            Console.WriteLine(product);

            int quotient = Params.AnyLengthQuo(16, 2, 2, 2);
